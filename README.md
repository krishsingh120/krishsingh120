...
- ☁️ Experienced with **AWS (EC2, S3, RDS)**, **Docker**, and **CI/CD pipelines**
- 💾 Database expertise: **MongoDB**, **MySQL**, with focus on optimization and scalability
- 🧪 Quality-focused: **Jest** for unit testing, **Postman** for API testing
- 🧠 Competitive programmer: **200+ problems solved** on LeetCode with **1500+ rating**
- 🎨 Frontend skills: Building responsive UIs with **React.js**, **Redux Toolkit**, **GSAP**, and **Framer Motion**
...
- 🔭 Working on **microservices architecture** and **distributed systems**
- 🌱 Learning **Kubernetes** and **advanced system design patterns**
- 👯 Looking to collaborate on **open-source backend projects**
- 💬 Ask me about **Node.js, Express, APIs, AWS, Docker**
- ⚡ Fun fact: **I think bugs are features until proven otherwise**
